...
function genEmailContactBtn($post = null, bool $btnBlock = false, bool $iconOnly = false): string
{
	...
	if ($iconOnly) {
		...
		$out .= '<a href="' . $btnLink . '" data-bs-toggle="modal" class="saler__mail link link--flex' . $btnClass . '">';
		$out .= t('Send a message');
        $out .= '<svg class="saler__icon"><use xlink:href="/images/sprite.svg#mail"></use></svg>';
	}
	$out .= '</a>';
