...
class SocialController extends BaseController
{
	 ...
	 */
	public function getProviderTargetUrl(string $provider): \Illuminate\Http\JsonResponse | \Illuminate\Http\RedirectResponse
	{
		...
		try {
            return $this->respondSuccess(Socialite::driver($provider)->stateless()->redirect()->getTargetUrl());
		} catch (\Throwable $e) {
