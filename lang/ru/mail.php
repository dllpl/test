...
в ваш веб-браузер:',
    ...
    'email_example_content_2' => 'Это письмо было отправлено для проверки ваших новых учетных данных электронной почты для :appName. Поскольку вы получили это письмо, значит, почта настроена правильно, и это письмо можно игнорировать.',
    ...
    'email_verification_content_2' => 'Нажмите на кнопку ниже, чтобы подтвердить свой адрес электронной почты',
    'email_verification_content_3' => 'Вы получили это письмо, потому что недавно вы создали новый аккаунт или добавили новый адрес электронной почты в сервисе :appName. Если это не вы, пожалуйста, проигнорируйте это письмо.',
    ...
    'post_republished_title' => 'Ваше объявление опубликовано вновь',
    'post_republished_content_1' => 'Здравствуйте,',
    'post_republished_content_2' => 'Ваше объявление: <a href=":postUrl">:title</a> успешно опубликовано.',
    'post_republished_content_3' => 'Вы получили это письмо, потому что недавно создали новое объявление в :appName. Если это были не вы, пожалуйста, проигнорируйте это письмо.',
    'post_deleted_title' => 'Ваше объявление было удалено',
    'post_deleted_content_1' => 'Здравствуйте,',
    'post_deleted_content_2' => 'Ваше объявление ":title" было удалено.',
    'post_deleted_content_3' => 'Спасибо за ваше доверие и скоро увидимся.',
    'post_deleted_content_4' => 'PS: Это автоматическое письмо, пожалуйста, не отвечайте на него.',
...
<br>Номер телефона: :phone',
    'post_seller_contacted_content_2' => 'Это письмо было отправлено вам по поводу объявления ":title" : <a href=":postUrl">:postUrl</a>',
    ...
    'post_seller_contacted_content_7' => 'PS: Это автоматическое письмо, пожалуйста, не отвечайте на него.',
    'user_deleted_title' => 'Ваша учетная запись была удалена',
    'user_deleted_content_1' => 'Здравствуйте,',
    'user_deleted_content_2' => 'Ваша учетная запись была удалена с <a href=":appUrl">:appName</a>  :now.',
...
<br><br>Если у вас есть сомнения относительно серьезности рекламодателя, немедленно свяжитесь с нами. Мы сделаем все возможное чтоб защитить вас чтоб вы не стали жертвой обмана.',
    ...
    'post_archived_content_2' => 'Ваше объявление ":title" было заархивировано.',
    ...
    'post_archived_content_6' => 'ПС: Это автоматическое письмо, пожалуйста, не отвечайте на него.',
    'post_will_be_deleted_title' => 'Ваше объявление будет удалено через :days days',
    'post_will_be_deleted_content_1' => 'Здравствуйте,',
    'post_will_be_deleted_content_2' => 'Ваше объявление ":title" будет удалено через :days .',
    ...
    'post_will_be_deleted_content_6' => 'PS: Это автоматическое письмо, пожалуйста, не отвечайте на него.',
...
<br><strong>Способ оплаты:</strong> :paymentMethodName',
    'payment_approved_title' => 'Ваш платеж проверен',
    'payment_approved_content_1' => 'Здравствуйте,',
    'payment_approved_content_2' => 'Ваш платеж по "<a href=":postUrl">:title</a>" проверен.',
...
<br><strong>Payment Method:</strong> :paymentMethodName',
    ...
    'generated_password_content_1' => 'Здравствуйте, :userName!',
    'generated_password_content_2' => 'Ваш аккаунт успешно создан.',
    'generated_password_verify_content_3' => 'Нажмите сюда для подтверждения почты',
    'generated_password_verify_action' => 'Подтвердить электронную почту',
    'generated_password_content_4' => 'Ваш пароль: <strong>:randomPassword</strong>',
    'generated_password_login_action' => 'Авторизоваться!',
    'generated_password_content_6' => 'Вы получили это письмо, потому что недавно создали новую учетную запись :appName или добавили новый адрес электронной почты. Если это были не вы, пожалуйста, проигнорируйте это письмо.',
];
