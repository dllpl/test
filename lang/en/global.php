...
return [
    ...
    'add_to_favorites' => 'Add advert to favorites',
    'advertisement_posted_from'=>'Advertisement posted from',
    'show_phone' => 'Show phone',
    'сharacteristics'=> 'Characteristics',
    'register_on_the_site'=> 'Register on the site to start buying and selling with',
    'face_type'=>'Face type',
    'full_name'=>'Full name',
    'choice_your_variant'=>'Select your option',
    'post_free_ads' => 'Post free ads',
    'post_free_ads_desc'=>'Do you have anything for sale, rent or provide services or work? Publish your ads - its free and easy to use',
    'make_your_purchases'=>'Make your purchases',
    'make_your_purchases_desc'=>'We represent more than 1,000 sellers from all over Russia and the CIS countries - here you will find what you have been looking for for a long time. Add advertisements to your favorites so as not to lose',
    'click_the_button_agree'=>'By clicking the button, you consent to processing',
    'and_familiarized'=>'and familiarized with',
    'profile'=>'Profile',
    'accreditation'=>'Accreditation',
    'public_again'=>'Post again',
    'accred_on_proccess'=>'Your application is being processed. Please wait for a solution',
    'accred_close'=>'Application rejected',
    'accred_user'=>'You are an accredited AUTOMOST user',
    'accred_user_yes'=>'Accredited user',
    'how_to_get_accred'=>'The “Accredited User” mark can only be obtained by professional AUTOMOST users who confirm their professional activities in the automotive field. To confirm your account, the service manager may ask you to provide additional information confirming your professional activities.',
    'how_to_get_accred?'=>'How to get accreditation?',
    'how_to_get_accred_info'=>'To receive the “Accredited User” mark, click on the button below to automatically generate an application for verification. Later, the service manager will contact you to clarify the details of your activities and confirm your account.',
    'avail_accred_user?'=>'What is available to an accredited user?',
    'accred_avail_1'=>'Accredited users have a unique opportunity to be the first to see advertisements for selling or searching for cars within 12 hours. Regular users will see ads only 12 hours after it is published.',
    'accred_avail_2'=>'Accredited users are marked with a special mark “Verified User”',
    'make_accred'=>'Apply for accreditation',
    'manager_contact_you'=>'A manager will contact you, wait for the call',
