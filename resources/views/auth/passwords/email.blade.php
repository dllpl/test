...
{{--									<div class="input-group">--}}
										...
										>
										<div class="form-text">
											Нажмите Отправить и мы пришлем ссылку со сбросом пароля на указанный эл. адрес в течение 5 минут
										</div>
{{--									</div>--}}
								</div>
								...
								<div class="mb-3 text-end">
									<button id="pwdBtn" type="submit" class="form__btn btn btn-reset btn--accent d-inline">{{ t('submit') }}</button>
								</div>
							</form>
						</div>
