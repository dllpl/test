						...
						<div class="card card-default">
							...
							<div class="panel-intro">
								<div class="d-flex justify-content-center">
									<h2 class="logo-title" style="color: #79B285"><strong>{{ t('log_in') }}</strong></h2>
								</div>
							</div>
							...
							<div class="card-body px-4">
								...
								{{-- Submit --}}
								<div class="mb-1">
									<button id="loginBtn" class="form__btn btn btn--accent btn-reset btn-block"> {{ t('log_in') }} </button>
								</div>
							</div>

							<div class="card-footer px-4" style="background-color: white; box-shadow: none; border-top: 0">
