                        ...
                        <div class="card card-default">
                            ...
                            <div class="panel-intro">
                                <div class="d-flex justify-content-center">
                                    <h2 class="logo-title" style="color: #79B285"><strong>{{ t('log_in') }}</strong>
                                    </h2>
                                </div>
                            </div>
                            ...
                            <div class="card-body px-4">
                                ...
                                <div class="mb-3 auth-field-item">
                                    <div class="row">
                                        ...
                                        @endphp
                                        <label class="form-label {{ $col }} m-0 py-2 text-left"
                                               for="email">{{ t('email') }}:</label>
                                        @if (config('settings.sms.enable_phone_as_auth_field') == '1')
                                            <div class="col-6 py-2 text-right">
                                                <a href="" class="auth-field"
                                                   data-auth-field="phone">{{ t('login_with_phone') }}</a>
                                            </div>
                                        @endif
                                    </div>
                                ...
                                @if (config('settings.sms.enable_phone_as_auth_field') == '1')
                                    ...
                                    <div class="mb-3 auth-field-item">
                                        <div class="row">
                                            <label class="form-label col-6 m-0 py-2 text-left"
                                                   for="phone">{{ t('phone_number') }}:</label>
                                            <div class="col-6 py-2 text-right">
                                                <a href="" class="auth-field"
                                                   data-auth-field="email">{{ t('login_with_email') }}</a>
                                            </div>
                                        </div>
                                        <input id="phone" name="phone"
                                               type="tel"
                                               class="input input--default {{ $phoneError }}"
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="input-group show-pwd-group">
                                        <input id="password" name="password"
                                               type="password"
                                               class="input input--default {{ $passwordError }}"
                                ...
                                <div class="mb-1">
                                    <button id="loginBtn"
                                            class="form__btn btn btn--accent btn-reset btn-block"> {{ t('log_in') }} </button>
                                </div>
                            </div>

                            <div class="card-footer px-4"
                                 style="background-color: white; box-shadow: none; border-top: 0">
