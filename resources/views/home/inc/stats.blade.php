...
<section class="counts {{ $hideOnMobile }}">
	<div class="counts__container container">
		<ul class="list-reset counts__list">
			<li class="counts__item">
				<span class="counts__num">
				...
				<h5 class="counts__text">{{ t('classified_ads') }}</h5>
			</li>
			<li class="counts__item">
				<span class="counts__num">
				...
				<h5 class="counts__text">{{ t('locations') }}</h5>
			</li>
			<li class="counts__item">
				<span class="counts__num">
