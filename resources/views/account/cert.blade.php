                ...
                <div class="lk__content">
                    ...
                    @if(\App\Helpers\SuperUser::status() === null)
                        ...
                        @elseif(\App\Helpers\SuperUser::status() === 1)
                            <h2 class="lk__title title title--medium"><img src="/images/logo-2.png"> Вы аккредитованный пользователь AUTOMOST</h2>
                        @endif
                        <h3 class="mb-3 title">Аккредитованный пользователь</h3>
                        <p class="mb-3">Отметку «Аккредитованный пользователь» могут получить только профессиональные пользователи
                        ...
                        <ul class="mb-3">
                            <li style="list-style-type: disc">Отметку «Аккредитованный пользователь» могут получить только профессиональные пользователи AUTOMOST,
