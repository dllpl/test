			...
			<div class="lk__wrapp">
				...
				<div class="lk__content">
					...
					<div class="lk__form">
						...
						@endphp
						<div class="form form__container {{$photoPanelClass}}">
							<form class="form-foto" name="photoUpdate" role="form" method="POST" action="{{ url('account/photo') }}">
								<div class="form-foto__top">
									<div class="form-foto__flex-wrapp">
					...
					<div class="lk__form">
						<h2 class="lk__title title title--medium">{{ t('Account Details') }}</h2>
...
{{--									</li>--}}
									...
									<li class="form__item">
										<label class="form__label{{ $usernameError }}" for="username">{{ t('Username') }}</label>
										<input id="username" name="username"
											   type="text"
											   class="input input--default form-control{{ $usernameError }}"
						...
						<li class="form form__container">
							<form
								...
								<ul class="list-reset form__list">
									...
									<li class="form__item">
										<label class="form__label{{ $passwordError }}">{{ t('New Password') }}</label>
										<input id="password" name="password"
											   type="password"
											   class="input input--default form-control{{ $passwordError }}"
									...
									<?php $passwordError = (isset($errors) && $errors->has('password')) ? ' is-invalid' : ''; ?>
									<li class="form__item">
										<label class="form__label{{ $passwordError }}">{{ t('Confirm Password') }}</label>
...
{{--					<div class="inner-box default-inner-boxinner-box" style="overflow: visible;">--}}
